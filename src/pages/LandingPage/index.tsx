...
const LandingPage = () => {
    return (
        <div className="bg-landingPage w-screen h-screen bg-cover bg-no-repeat flex justify-center p-10">
            <div className="min-1440:w-[1440px] w-full flex flex-col justify-between">
                <header className="w-full flex items-center justify-between py-5">
                    <img src={"/ng-cash-icon.png"} alt="ng cash icon" className="w-20 text-black"/>
                    <div>
                        <User size={32} />
                    </div>
                </header>
